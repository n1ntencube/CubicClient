...
-- Mandatory mods are marked with mandatory=1 and are always downloaded
...
-- Query to view all mods for the Mod Repository
-- SELECT id, mod_name, mod_url, mod_version, enabled, mandatory, description FROM mods ORDER BY mandatory DESC, mod_name;
